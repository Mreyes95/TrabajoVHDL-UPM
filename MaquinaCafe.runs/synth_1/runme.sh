...
HD_PWD='C:/Users/mreye/Desktop/MaquinaCafe/MaquinaCafe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maquina_cafe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maquina_cafe.tcl
