...
set_property PACKAGE_PIN P17 [get_ports {Pulsador[0]}]
set_property PACKAGE_PIN P18 [get_ports {Pulsador[1]}]
set_property PACKAGE_PIN M17 [get_ports {Pulsador[2]}]
set_property PACKAGE_PIN M18 [get_ports {Pulsador[3]}]
...
set_property PACKAGE_PIN K16 [get_ports {salida_final[2]}]
set_property PACKAGE_PIN K13 [get_ports {salida_final[3]}]
set_property PACKAGE_PIN P15 [get_ports {salida_final[4]}]
set_property PACKAGE_PIN T11 [get_ports {salida_final[5]}]
set_property PACKAGE_PIN T10 [get_ports {salida_final[0]}]
set_property PACKAGE_PIN R10 [get_ports {salida_final[1]}]
set_property PACKAGE_PIN L18 [get_ports {salida_final[6]}]
set_property PACKAGE_PIN H15 [get_ports {salida_final[7]}]
set_property PACKAGE_PIN U13 [get_ports {control_salida[0]}]
set_property PACKAGE_PIN K2 [get_ports {control_salida[1]}]
set_property PACKAGE_PIN T14 [get_ports {control_salida[2]}]
set_property PACKAGE_PIN P14 [get_ports {control_salida[3]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {Pulsador[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Pulsador[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Pulsador[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {Pulsador[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {salida_final[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_salida[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_salida[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_salida[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {control_salida[0]}]
